...
//const productLiClone = productLi.cloneNode(this);
...
//console.log(productLi,productLiClone,productUl); // 오류확인
...
//비동기작업 (B)는 콜백 큐에 저장되고 준비가 되면 순차적 순서 상관없이 독립적으로 상행된다.
...
function startCountDownFunc(){
    ...
    const startCountDown = setInterval(()=>{
        ...
        if(num < 1){
            ...
            saleTimer.textContent='종료되었습니다.'
        }else{
            saleTimer.textContent=`${num}초`;
        }
    },1000);
}
